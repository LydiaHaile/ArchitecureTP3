...
def createInstances(ec2_client, ec2, SECURITY_GROUP, availabilityZones):
    ...
    instances_t2_SA = createInstance(ec2, "t2.micro", 1, SECURITY_GROUP, availability_zone_1a, userdata)
...
def paramiko(client, accesKey, ip):
    try:
...
def main():
    ...
    """------------------paramiko----------------------------"""
    #paramiko(paramiko_client, accesKey, SA_instance_id[0]['Ip'])
